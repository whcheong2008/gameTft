...
| 11 | HIGH | Combat / Abilities | 12 roster units (ashen_watcher, abyssal_guardian, grove_warden, tempest_weaver, voltfang_stalker, iron_duelist + their 6 evolved forms) have full ability data and mana-cast wiring but NO `case` in `executeAbility` — their casts do nothing mechanically. Pre-existing; found by Prompt 73's VFX mapping. | OPEN — assigned Prompt 74 |
