...
namespace ShatteredVeil.Tests.EditMode.Units
{
    ...
    {
        [Test]
        public void StarMultiplier_Star1_Is1()
        {
            Assert.AreEqual(1.0, UnitStatCalculator.GetStarMultiplier(1), 0.001);
        }

        [Test]
        public void StarMultiplier_Star2_Is1p4()
        {
            Assert.AreEqual(1.4, UnitStatCalculator.GetStarMultiplier(2), 0.001);
        }

        [Test]
        public void StarMultiplier_Star5_Is2p8()
        {
            Assert.AreEqual(2.8, UnitStatCalculator.GetStarMultiplier(5), 0.001);
        }

        [Test]
        public void StarMultiplier_ClampsBelowRange()
        {
            Assert.AreEqual(1.0, UnitStatCalculator.GetStarMultiplier(0), 0.001);
        }

        [Test]
        public void StarMultiplier_ClampsAboveRange()
        {
            Assert.AreEqual(3.2, UnitStatCalculator.GetStarMultiplier(99), 0.001);
        }

        [Test]
        public void CalculateHP_ScalesWithStars()
        {
            var unit = new UnitData { BaseHP = 1000 };
            Assert.AreEqual(1000, UnitStatCalculator.CalculateHP(unit, 1));
            Assert.AreEqual(1400, UnitStatCalculator.CalculateHP(unit, 2));
            Assert.AreEqual(1800, UnitStatCalculator.CalculateHP(unit, 3));
        }

        [Test]
        public void CalculateATK_ScalesWithStars()
        {
            var unit = new UnitData { BaseATK = 100 };
            Assert.AreEqual(100, UnitStatCalculator.CalculateATK(unit, 1));
            Assert.AreEqual(140, UnitStatCalculator.CalculateATK(unit, 2));
        }
    }
}
